...
\node[entity] (pricedaily) at (-2, -2) {PriceDaily};
\node[key attr] (pd_cid) at (-5.2, -0.8) {\underline{company\_id}};
\node[key attr] (pd_date) at (-5.2, -2) {\underline{trading\_date}};
\node[key attr] (pd_sid) at (-5.2, -3.2) {\underline{source\_id}};
...
\node[entity] (articlemention) at (16, -2) {ArticleMention};
\node[key attr] (am_aid) at (13.5, -3.2) {\underline{article\_id}};
\node[key attr] (am_cid) at (16, -3.5) {\underline{company\_id}};
...
\node[rel] (has_price) at (2.5, 1) {\scriptsize has};
\node[rel] (provides) at (-2, 1) {\scriptsize provides};
\node[rel] (defines) at (7, 1) {\scriptsize defines};
\node[rel] (mentioned) at (11.5, 1) {\scriptsize mentioned\_in};
\node[rel] (mentions) at (16, 1) {\scriptsize mentions};
